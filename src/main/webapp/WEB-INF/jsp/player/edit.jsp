...
<div class="main-content">
    ...
    <form:form method="POST" id="editForm" enctype="multipart/form-data" action="/admin/player/edit" class="handle-upload" modelAttribute="editForm" >
            ...
            <div class="row">
                 ...
                 <div class="col-sm-3">
                     <form:input path="nationality" class="inputbox-cheil-small" placeholder="Nationality"/>
                     <span>Nationality</span>
                     <form:errors path="nationality" class="text-danger"></form:errors>
                 </div>

                 <div class="col-sm-3">
                      <form:input type="date" path="dob" class="inputbox-cheil-small" placeholder="Birth Date" />
                 ...
                 <div class="col-sm-3">
                  <form:input type="file" path="playerImage" class="inputbox-cheil-small" />
                 </div>
            </div>
    </form:form>
