...
public interface EntityConstants {
    ...
    String MOBILE_TOKEN = "MobileToken";
    String PENDING_WITHDRAWL = "PendingWithdrawal";
    String PLAYER_ROLE = "PlayerRole";
    String PLAYER = "Player";
    String POINTS_MASTER = "PointsMaster";
    String POINTS_UPDATE = "PointsUpdate";
    String ROLE = "Role";
    ...
    String USER_WINNINGS = "UserWinnings";
    String WITHDRAWAL_METHODS = "WithdrawalMethods";
