...
import com.avitam.fantasy11.tokenGeneration.JwtFilter;
                ...
                .authorizeHttpRequests((requests) -> {
                            try {
                                requests
                                        ...
                                        .requestMatchers("/css/**", "/images/**", "/vendors/**", "/api/**", "/maps/**", "/resources/**", "/register", "/login", "/forgotpassword", "/resetpassword", "/handleUploadOperation", "/registrationConfirm", "/admin/email/send-otp", "/admin/email/validate-otp", "/admin/email/save-userName", "/admin/mobile/send-otp", "/admin/mobile/validate-otp", "/admin/mobile/save-username","/admin/role","/admin/role/get").permitAll()
